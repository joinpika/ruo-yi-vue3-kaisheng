<template>
  <div>
          ...
          <el-row :gutter="10">
            ...
            <!--<el-col :xs="24" :sm="12">
              <el-form-item label="入库状态" prop="stockStatus">
                <el-select v-model="formData.stockStatus" placeholder="请选择入库状态" style="width: 100%"
                  :disabled="disabledFlag">
          ...
          <el-row :gutter="10">
            ...
            <el-col :xs="24" :sm="12">
              <el-form-item label="产品规格" prop="productSpec">
                <!-- <el-select v-model="formData.productSpec" style="width: 100%" placeholder="请选择产品规格"
                  :disabled="disabledFlag">
                  <el-option v-for="item in specificationsOptions" :key="item.value" :label="item.label"
                    :value="item.value" />
                </el-select> -->
            ...
            <el-col :xs="24" :sm="12">
              <el-form-item label="切割图号" prop="cuttingDrawingNo">
                <el-input v-model="formData.cuttingDrawingNo" placeholder="请输入切割图号" style="width: 100%"
                  :disabled="disabledFlag" />
                <!-- <el-select v-model="formData.cuttingDrawingNo" style="width: 100%" placeholder="请选择切割图号"
                  :disabled="disabledFlag">
                  <el-option v-for="item in cutOptions" :key="item.value" :label="item.label" :value="item.value" />
                </el-select> -->
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12">
            ...
            <el-col :xs="24" :sm="24">
              <el-form-item label="玻璃数量" prop="glassQuantity">
                <el-input v-model="formData.glassQuantity" type="number" placeholder="请输入玻璃数量" style="width: 100%"
                  :disabled="disabledFlag" />
                <!-- <el-select v-model="formData.glassQuantity" style="width: 100%" placeholder="请选择"
                  :disabled="disabledFlag">
                  <el-option :value="1" label="1片" />
                  <el-option :value="2" label="2片" />
                </el-select> -->
              </el-form-item>
            </el-col>
          </el-row>
              ...
              <el-row :gutter="10">
                <el-col :xs="24" :sm="12">
                  <el-form-item label="玻璃颜色" prop="innerGlassColor">
                    <el-input v-model="formData.innerGlassColor" placeholder="请输入玻璃颜色" style="width: 100%"
                      :disabled="disabledFlag" />
                    <!-- <el-select v-model="formData.glassColor" placeholder="请选择玻璃颜色" style="width: 100%"
                      :disabled="disabledFlag">
                      <el-option v-for="item in glassColorOptions" :key="item.value" :label="item.label"
                        :value="item.value" />
                    </el-select> -->
                  </el-form-item>
                </el-col>
              ...
              <el-row :gutter="10">
                <el-col :xs="24" :sm="12">
                  <el-form-item label="胶体种类" prop="colloidType">
                    <!-- <el-select v-model="formData.zl" style="width: 100%" placeholder="请选择胶体种类" :disabled="disabledFlag">
                      <el-option :value="1" label="1片" />
                      <el-option :value="2" label="2片" />
                    </el-select> -->
    ...
    <!-- 选择厂商 -->
    <!-- <el-drawer v-model="venterDrawer.visible" :title="venterDrawer.title" size="80%" direction="rtl"
      :before-close="handleVenterDrawerClose">
      <div style="height: calc(100% - 55px); overflow-y: auto;">
        <venter v-if="venterDrawer.visible" ref="venter" />
      </div>
      <div class="drawer-footer"
        style="position: absolute; bottom: 0; width: 100%; padding: 10px; background-color: #fff; border-top: 1px solid #e6ebf5;">
        <el-button @click="venterDrawer.visible = false">取消</el-button>
        <el-button type="primary" @click="selectManufacturer">提交</el-button>
      </div>
    </el-drawer> -->
  </div>
</template>
...
// import venter from "@/views/basic/venter/index.vue";
...
// 方法定义
const openDialog = (type, row = null, typeParam) => {
  showDialog.value = true;
  types.value = typeParam;
  Object.keys(formData).forEach(key => {
    formData[key] = "";
  });
  formData.productType = typeParam;
  if (type === "add") {
    title.value = typeParam ? `新增${typeParam}` : "新增成品";
    disabledFlag.value = false;
  } else if (type === "edit") {
    title.value = typeParam ? `修改${typeParam}` : "修改成品";
    disabledFlag.value = false;
      if (row) {
    ...
    title.value = typeParam ? `查看${typeParam}` : "查看成品";
