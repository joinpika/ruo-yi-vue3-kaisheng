  ...
  <div class="container">
    <div class="wrap-content">
      ...
      <div class="search-box">
        <el-form :inline="true" :model="searchForm" size="small">
          <el-form-item label="成品名称">
            <el-input v-model="searchForm.productName" placeholder="请输入成品名称" @keyup.enter.native="getList" />
          </el-form-item>
          <el-form-item label="成品编码">
            <el-input v-model="searchForm.productCode" placeholder="请输入成品编码" @keyup.enter.native="getList" />
          </el-form-item>
        </el-form>
      ...
      <div class="operation-btns">
        <el-button type="primary" icon="el-icon-plus" size="small" @click="handleDialog('add')" :disabled="addFlag">新增</el-button>
        <!-- <el-button size="small" mini plain icon="el-icon-plus" @click="handleAddProduct">产品档案新增</el-button> -->
      </div>
    ...
    <!-- 产品分类档案 -->
    <!-- <el-dialog :title="titleOpen" :visible.sync="open" width="500px" append-to-body>
...
const getFileTree = () => {
  ...
  deptOptions.value = [
    ...
    // handleAddProduct() {
    //   this.$nextTick(() => {
    //     this.$refs.formOpen && this.$refs.formOpen.clearValidate();
    //   });
    //   this.formOpenData = {
    //     postName: "",
    //   };
    ...
    //     if (valid) {
    //       // addAdmin(this.formOpenData).then(() => {
    //       //   this.cancel();
    //       //   this.$message({
    //       //     message: "添加成功",
    //       //     type: "success",
